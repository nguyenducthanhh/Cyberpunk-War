...
public class Enemy3 : Enemy
{
   ...
   // private Animator animator;
    ...
    //    if (player != null)
    //    {
    //        Vector3 directionToPlayer = targetPlayer.transform.position - firePoint.transform.position;
    //        directionToPlayer.Normalize();
    //        GameObject bullet = Instantiate(BulletPrefabs, firePoint.transform.position, Quaternion.identity);
